...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//I'm going to change some code around in this file that way I can build targeting the Android binaries.
//There is no way to load UUID libraries when building for the ANDROID target that I know of yet.
//So far I have turned off including UUID libraries in cmake by commenting out a certain section.
//Now I need to change this code so it doesn't try to reference the libraries that I have taken out.
//Look for things such as #ifdef USE_UUID_GENERATE
//
//
//
//update 6/5/2014 I'm going to trace the changes I made and remove them because I should be able to link to a 
//UUID library now.
//
//
//
...
/*
The below code in the #else ... #endif block is my attempt at getting proton-c library to build 
whilst linking to a compiled android uuid library.
*/
#else
#include <uuid/uuid.h>
#include <stdlib.h>
...
This else statement is what I used to get proton-c library to compile without having access to a UUID Library. 
I generated a stub for the pn_i_genuuid(void) function that basically did nothing.
But now I have access to a library so I need to utilize that library.
...
/*
#else
#error "Don't know how to generate uuid strings on this platform"	//Commented out by Jimmy.
#endif
*/
